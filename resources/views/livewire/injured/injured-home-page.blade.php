<div>
    <div class="mx-auto px-6 py-6 text-center">
        <h1 class="text-4xl font-extrabold text-gray-900 dark:text-green-400 mb-6">Functionality is coming soon</h1>
    </div>
    <div  class="container mx-auto px-6 py-12 opacity-50 pointer-events-none">
        {{-- The best athlete wants his opponent at his best. --}}
        <section class="text-center">
            <h1 class="text-4xl font-extrabold text-gray-900 dark:text-gray-200 mb-6">Wish Them a Quick Recovery</h1>
            <p class="text-gray-600 dark:text-gray-400 text-lg">Search for injured or hospitalized persons. Together, we can make a difference.</p>
            {{-- <div class="mt-8">
