<div  class="container mx-auto px-6 py-12">
    ...
    <section class="text-center">
        ...
        <p class="text-gray-600 dark:text-gray-400 text-lg">Check on the injured. Together, we can make a difference.</p>
        {{-- <div class="mt-8">
    ...
    <section id="recent" class="mt-12">
        ...
        <div class="grid grid-cols-1 md:grid-cols-3 gap-6">
            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
                ...
                <p class="text-gray-600 dark:text-gray-400">Satus: Hospitalized</p>
            </div>

            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
                <img src="{{asset('placeholderimages/john-doe.avif')}}" alt="Person 1" class="w-full h-58 object-cover rounded">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mt-4">John Doe</h3>
                <p class="text-gray-600 dark:text-gray-400">Satus: Full recovery</p>
            </div>

            <div class="bg-white dark:bg-gray-800 shadow rounded-lg p-4">
                <img src="{{asset('placeholderimages/john-doe.avif')}}" alt="Person 1" class="w-full h-58 object-cover rounded">
                <h3 class="text-xl font-semibold text-gray-800 dark:text-gray-200 mt-4">John Doe</h3>
                <p class="text-gray-600 dark:text-gray-400">Status: Maimed</p>
            </div>
        </div>
    </section>
