<div class="max-w-4xl mx-auto my-5 bg-white dark:bg-gray-800 p-6 rounded-lg shadow-md">
    <h2 class="text-2xl font-semibold mb-6 dark:text-gray-200">Edit Missing Person</h2>
    ...
    <form wire:submit.prevent="submit" enctype="multipart/form-data">
        <!-- Current Poster -->
        <div class="mb-4">
            <label class="block text-sm font-medium mb-1 dark:text-gray-200">Current Poster</label>
            @if ($currentPoster)
                <img src="{{ asset($currentPoster ? 'storage/poster/' . $currentPoster : 'placeholderimages/john-doe.avif') }}" alt="Current Poster" class="w-32 h-32 object-cover mb-2">
            @endif
